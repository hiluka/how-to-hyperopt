---
title: The Role of Hyperparameters in Machine Learning Models and How to Tune Them (PSRM, 2023)
author: "Christian Arnold, Luka Biedebach, Andreas Küpfer, and Marcel Neunhoeffer"
date: "2023-07-05"
output: pdf_document
---
...
# -- Data ---------------------------------------------------------------------- 
dat.temp <- read.csv("data/annotations_march22_2023.csv", sep = ',', header = TRUE)
dat <- subset(dat.temp, 
